                        ...
                        lista.innerHTML = d.data.map(item => `
                            <div class="task-item">
                                ...
                                <div class="task-description">
                                    ...
                                    ⏰ Jornada: ${escapeHtml(item.jornada)}<br>
                                    💰 Valor: $${parseFloat(item.valor).toFixed(2)}
                                </div>
                                <div class="task-actions">
                                    <button class="btn btn-editar" onclick="prepararEdicion(${item.id}, ${item.refrigerio_id}, ${item.jornada_id}, ${item.proveedor_id}, ${item.valor})">✏️ Editar</button>
