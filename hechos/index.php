                        ...
                        <tbody>
                            ${data.data.map(h => `
                                <tr>
                                    ...
                                    <td class="no-print">
                                        <button class="btn btn-sm btn-editar" onclick="prepararEdicion(${h.id}, ${h.fecha_id}, ${h.proveedor_id}, ${h.seccion_id}, ${h.refrigerio_id}, ${h.jornada_id}, ${h.cantidad}, ${h.valor_unitario}, '${escapeAttr(h.cuenta_cobro || '')}')">✏️</button>
